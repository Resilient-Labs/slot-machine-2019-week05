// negative bank amounts should not be allowed - make if/then
// "you win" message should go away after new bet - handled in line 31
...
function minBet() {
  ...
  if (iWin()) {
    document.getElementById('results').innerHTML= "You win! Get that bag, sis!";
...
// document.querySelector('results')= maxBet
// maxBet();
// maxBet();
// maxBet();
...
// other functions for win
// check if they won need a comparision+return

function iWin() {
  return wheel1 === wheel2 && wheel2 === wheel3;
}

// number of spaces we want it to spin will be the # of offset
